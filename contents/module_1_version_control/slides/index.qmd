...
- Requires a master document
- Often scales poorly (to only a few participants)
- Availablility of complete history is questionable
...
-   Useful for **collaboration** (**GitHub**/**GitLab**)
...
![[From Pawel, S., Molo, F., Kehl, M. (2026). Good Statistical Practice. <https://biostat.pages.uzh.ch/sta472/gsp.>]{style="font-size:0.7em"}](img/git-workflow.png){fig-align="center"}
...
::: incremental
-   Create a **personal access token** in user settings (with read & write privileges)
